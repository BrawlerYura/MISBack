...
public class DictionaryController
{
    ...
    [HttpGet]
    [Route("speciality")]
    public async Task<SpecialtiesPagedListModel> GetSpecialtiesList([FromQuery] string? name, [FromQuery] int page = 1,
    ...
    [HttpGet]
    [Route("icd10")]
    public async Task<Icd10SearchModel> GetDiagnosisList([FromQuery] string? request, [FromQuery] int page = 1,
        [FromQuery] int size = 5)
    {
